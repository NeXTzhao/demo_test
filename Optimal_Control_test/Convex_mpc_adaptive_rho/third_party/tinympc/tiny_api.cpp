...
int tiny_setup(TinySolver** solverp,
                ...
                tinytype rho, int nx, int nu, int N, int verbose, int adaptive_rho_flag) {
...
int tiny_set_default_settings(TinySettings* settings) {
    ...
    settings->adaptive_rho_min = 1e-4;
    settings->adaptive_rho_max = 1e3;
    settings->adaptive_rho_enable_clipping = 1;
    settings->matrices_initialized = false;
...
void tiny_initialize_sensitivity_matrices(TinySolver *solver) {
    ...
    const float dKinf_drho[2][8] = {
        {  0.003008,   0.000000,   0.002902,   0.000000,   0.000000,   0.000000,  -0.001245,   0.002257},
        {  0.000000,   0.001740,   0.000000,  -0.004469,  -0.006280,  -0.003967,   0.000000,   0.000000}
    };
    const float dPinf_drho[8][8] = {
        { 37.945661,   0.000000,  11.481674,   0.000000,   0.000000,   0.000000, -26.149951,   4.592403},
        {  0.000000,  17.041466,   0.000000,  40.195108,  19.561313,   6.751463,   0.000000,   0.000000},
        { 11.481674,   0.000000,  40.372198,   0.000000,   0.000000,   0.000000,  11.474043,  19.809418},
        {  0.000000,  40.195108,   0.000000, 148.360376,  85.669209,  33.157757,   0.000000,   0.000000},
        {  0.000000,  19.561313,   0.000000,  85.669209,  65.395324,  29.165910,   0.000000,   0.000000},
        {  0.000000,   6.751463,   0.000000,  33.157757,  29.165910,  20.554712,   0.000000,   0.000000},
        {-26.149951,   0.000000,  11.474043,   0.000000,   0.000000,   0.000000,  37.940303,   4.585492},
        {  4.592403,   0.000000,  19.809418,   0.000000,   0.000000,   0.000000,   4.585492,  17.103722}
    };
    const float dC1_drho[2][2] = {
        { -0.004970,   0.000000},
        {  0.000000,  -0.004869}
    };
    const float dC2_drho[8][8] = {
        {  0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000000,  -0.000602},
        {  0.000000,   0.000000,   0.000000,   0.000000,   0.000000,  -0.000348,   0.000000,   0.000000},
        {  0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000000,  -0.000580},
        {  0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000894,   0.000000,   0.000000},
        {  0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.001256,   0.000000,   0.000000},
        {  0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000793,   0.000000,   0.000000},
        {  0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000249},
        {  0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000000,   0.000000,  -0.000451}
    };

    // Map arrays to Eigen matrices
    solver->cache->dKinf_drho = Map<const Matrix<float, 2, 8>>(dKinf_drho[0]).cast<tinytype>();
    solver->cache->dPinf_drho = Map<const Matrix<float, 8, 8>>(dPinf_drho[0]).cast<tinytype>();
    solver->cache->dC1_drho = Map<const Matrix<float, 2, 2>>(dC1_drho[0]).cast<tinytype>();
    solver->cache->dC2_drho = Map<const Matrix<float, 8, 8>>(dC2_drho[0]).cast<tinytype>();
}
